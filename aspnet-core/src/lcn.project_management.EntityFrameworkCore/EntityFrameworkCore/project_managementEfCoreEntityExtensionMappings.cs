...
{
    public static class project_managementEfCoreEntityExtensionMappings
    {
        ...
        public static void Configure()
        {
            ...
            OneTimeRunner.Run(() =>
            {
                 ...
                 * USE project_managementModuleExtensionConfigurator CLASS (in the Domain.Shared project)
